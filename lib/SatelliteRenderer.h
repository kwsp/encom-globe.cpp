...
public:
    SatelliteRenderer();
    SatelliteRenderer(SatelliteRenderer &&) = delete;
    SatelliteRenderer(const SatelliteRenderer &) = delete;
    SatelliteRenderer operator=(SatelliteRenderer &&) = delete;
    SatelliteRenderer &operator=(const SatelliteRenderer &) = delete;
